...
urlpatterns = [
    ...
    path("projects/<int:pk>/analytics/", views.analytics, name="analytics"),
    ...
    path("projects/<int:pk>/store/", views.store, name="store"),
    path("projects/<int:pk>/store/orders/<int:order_id>/", views.order_detail, name="order_detail"),
